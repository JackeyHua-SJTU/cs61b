...
public class SimpleOomage implements Oomage {
    ...
    /** the first case is a shortcut for a special circumstance.
     *  we should notice that when o is null or o does not share
     *  a class with this, then we should definitely return false.
     */
    @Override
    public boolean equals(Object o) {
        ...
        SimpleOomage cast = (SimpleOomage) o;
        return (this.red == cast.red) && (this.blue == cast.blue) && (this.green == cast.green);
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return (red * green * blue + 16 * red + 8 * green + 4 * blue) / 5;
        }
    }
